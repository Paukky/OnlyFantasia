              ...
              {!imageAsset ? (
                <label>
                  <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <p className="mt-32 text-gray-400"> Use high-quality photo JPG, SVG, PNG, GIF less than 20MB</p>
                  </div>
                  <input
                    type="file"
                    name="upload-image"
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          {user && (
            ...
            <div className="flex flex-col">
              <div>
                <p className="mb-2 font-semibold text-lg sm:text-xl">Choose your Categories</p>
                <select
...
//TODO: will work on adding in multiple having multiple tags later
/*<select
                  multiple="true"
                  onChange={(e) => setCategory(e.target.value)}
                  className="outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer"
